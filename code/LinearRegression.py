...
import numpy as np
import Rose.NgramSegment as Ngram
import Rose.MessageSegment as MS
import Rose.Messageseg as msg
# 函数
...
# 进行ngrams分割
    ...
    # 建立初始方程
    primary_equation = PrimaryEquation(ngrams,max_gramdimension)    # 记录每条数据包的十进制字段。 形式形如[ [f11,f12,...,f1n],...,[fi1,fi2,...,fin],[fm1,fm2,...,fmn] ]
